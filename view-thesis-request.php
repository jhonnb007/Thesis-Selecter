<!-- Modal -->
<div class="modal fade" id="thesisRequest" tabindex="-1" role="dialog" aria-labelledby="thesisAdministradorLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <input type="hidden" id="acceptID" name="accept">
      ...
      <div class="modal-body">
        <table class="table table-striped table-hover">
            <tbody>
                ...
                <tr>
                    <td><h5><a href="javascript:;">Número de alumnos requeridos:</a></h5></td>
                    <td id="plazas">2</td>
                </tr>
                <tr>
      ...
      <div class="modal-footer">
        <button type="submit" name="btnAceptar" class="btn btn-success">Aceptar tesis</button>
